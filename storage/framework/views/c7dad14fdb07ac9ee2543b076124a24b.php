...
<?php $__env->startSection('title'); ?>
    <?php echo e(ucfirst($tab ?? '') . ' ' . __('Settings - ' . config('app.name'))); ?>
...
<?php $__env->startSection('admin-content'); ?>
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <div x-data="{ pageName: '<?php echo e(__('Settings')); ?>' }">
            <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90"><?php echo e(__('Settings')); ?></h2>
                <nav>
                    <ol class="flex items-center gap-1.5">
                        ...
                        <li class="text-sm text-gray-800 dark:text-white/90"><?php echo e(__('Settings')); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.settings.store')); ?>" enctype="multipart/form-data">
                        ...
                        <?php echo $__env->make('backend.pages.settings.tabs', [
                            'tabs' => ld_apply_filters('settings_tabs', [
                                ...
                                //],
                                'commerce_settings' => [
                                    'title' => __('Commerce Settings'),
                                    'view' => 'backend.pages.settings.commerce-settings',
                                ],
                                'content' => [
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u829817072/domains/silver-quetzal-131368.hostingersite.com/varsity-laravel/resources/views/backend/pages/settings/index.blade.php ENDPATH**/ ?>