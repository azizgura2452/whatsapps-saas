...
" :class="{ 'dark bg-gray-900': darkMode === true }">
    ...
    <script>
        ...
        window.handleMediaClick = function (mediaId, mimeType) {
            ...
            fetch("<?php echo e(route('admin.whatsapp.chatbox.media', ':id')); ?>".replace(':id', mediaId))
                .then(res => {
...
</html><?php /**PATH C:\xampp\htdocs\varsity\resources\views/backend/layouts/app.blade.php ENDPATH**/ ?>