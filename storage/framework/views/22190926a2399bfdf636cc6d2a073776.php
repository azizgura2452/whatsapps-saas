    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <button
                ...
                <img src="<?php echo e(asset('images/icons/toggle-bar.svg')); ?>" class="dark:invert">
            </button>
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <?php if(env('GITHUB_LINK') ): ?>
                    <a href="<?php echo e(env('GITHUB_LINK')); ?>" target="_blank"
                        class="hover:text-dark-900 relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white">
                        <img src="<?php echo e(asset('images/icons/github.svg')); ?>" alt="GitHub" class="dark:invert" />
                    </a>
                <?php endif; ?>
            </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="<?php echo e(auth()->user()->getGravatarUrl()); ?>" alt="User" />
                    </span>
                        ...
                        <?php if($originalUser): ?>
                            <form method="POST" action="<?php echo e(route('admin.users.switch-back')); ?>" class="inline">
                                ...
                                <button type="submit"
                                    ...
                                    <?php echo e(__('Switch back to')); ?> <?php echo e($originalUser->name); ?>
...
<!-- End Header -->
<?php /**PATH /home/u829817072/domains/silver-quetzal-131368.hostingersite.com/varsity-laravel/resources/views/backend/layouts/partials/header.blade.php ENDPATH**/ ?>