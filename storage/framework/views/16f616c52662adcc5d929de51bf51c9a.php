                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="form-input  form-control">
                                <option value="1" <?php echo e(old('status') === 'active' ? 'selected' : ''); ?>><?php echo e(__('In Stock')); ?></option>
                                <option value="0" <?php echo e(old('status') === 'inactive' ? 'selected' : ''); ?>><?php echo e(__('Out of Stock')); ?></option>
                            </select>
                        </div>
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\varsity\resources\views/backend/pages/products/create.blade.php ENDPATH**/ ?>