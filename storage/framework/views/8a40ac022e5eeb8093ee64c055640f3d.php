                ...
                <table id="dataTable" class="w-full dark:text-gray-400">
                    <thead class="bg-light text-capitalize">
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <th width="12%" class="p-2 bg-gray-50 dark:bg-gray-800 dark:text-white text-left px-5"><?php echo e(__('Email')); ?></th>

                            
                            <th width="18%" class="p-2 bg-gray-50 dark:bg-gray-800 dark:text-white text-left px-5"><?php echo e(__('Business')); ?></th>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="<?php echo e($loop->index + 1 != count($users) ?  'border-b border-gray-100 dark:border-gray-800' : ''); ?>">
                                ...
                                <td class="px-5 py-4 sm:px-6 md:min-w-[180px]">
                                    <?php if(method_exists($user, 'business') && $user->relationLoaded('business') ? $user->business : $user->business ?? false): ?>
                                        <span class="inline-flex items-center justify-center px-2 py-1 text-xs font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white">
                                            <?php echo e(optional($user->business)->name ?? ('#'.$user->business_id)); ?>

                                        </span>
                                    <?php else: ?>
                                        
                                        <span class="text-sm text-gray-600 dark:text-gray-300">
                                            <?php echo e($user->business_id ? ('#'.$user->business_id) : '—'); ?>
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\varsity\resources\views/backend/pages/users/index.blade.php ENDPATH**/ ?>