...
<div class="p-4 mx-auto max-w-[var(--breakpoint-2xl)] md:p-6">
    <div x-data="{ pageName: '<?php echo e(__('Edit Role')); ?>' }">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90"><?php echo e(__('Edit Role')); ?></h2>
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li>
                        <a class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400" href="<?php echo e(route('admin.roles.index')); ?>">
                            <?php echo e(__('Roles')); ?>

                            <i class="bi bi-chevron-right"></i>
                        </a>
                    </li>
                    <li class="text-sm text-gray-800 dark:text-white/90"><?php echo e(__('Edit Role')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <form action="<?php echo e(route('admin.roles.update', $role->id)); ?>" method="POST">
        ...
        <div class="space-y-8">
            ...
            <div class="rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="p-4">
                    <div class="mb-4">
                        <input type="checkbox" id="checkPermissionAll" class="mr-2" <?php echo e($roleService->roleHasPermissions($role, $all_permissions) ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-6">
                        <div class="flex items-center mb-2">
                            <input type="checkbox" id="group<?php echo e($i); ?>Management" class="mr-2" <?php echo e($roleService->roleHasPermissions($role, $roleService->getPermissionsByGroupName($group->name)) ? 'checked' : ''); ?>>
                            <label for="group<?php echo e($i); ?>Management" class="capitalize text-sm font-medium text-gray-700 dark:text-gray-400">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-4" data-group="group<?php echo e($i); ?>Management">
                            ...
                            <div>
                                <input type="checkbox" id="checkPermission<?php echo e($permission->id); ?>" name="permissions[]" value="<?php echo e($permission->name); ?>" class="mr-2" 
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u829817072/domains/silver-quetzal-131368.hostingersite.com/varsity-laravel/resources/views/backend/pages/roles/edit.blade.php ENDPATH**/ ?>