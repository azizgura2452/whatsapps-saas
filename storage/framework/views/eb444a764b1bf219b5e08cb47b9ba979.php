...
<?php echo e(__('New Role')); ?> | <?php echo e(config('app.name')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('admin-content'); ?>
<div class="p-6 mx-auto max-w-7xl">
    <div x-data="{ pageName: '<?php echo e(__('New Role')); ?>' }">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90"><?php echo e(__('New Role')); ?></h2>
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li class="text-sm text-gray-800 dark:text-white/90"><?php echo e(__('New Role')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="p-4">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center mb-2">
                            <input type="checkbox" id="group<?php echo e($i); ?>Management" class="mr-2">
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u829817072/domains/silver-quetzal-131368.hostingersite.com/varsity-laravel/resources/views/backend/pages/roles/create.blade.php ENDPATH**/ ?>