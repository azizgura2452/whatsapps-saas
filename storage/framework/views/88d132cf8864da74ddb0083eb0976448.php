            ...
            <div class="space-y-3 border-t border-gray-100 dark:border-gray-800 overflow-x-auto">
                ...
                <table id="dataTable" class="w-full dark:text-gray-400">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <td class="px-5 py-4 sm:px-6"><?php echo e($products->firstItem() + $loop->index); ?></td>
                                ...
                                <td class="px-5 py-4 sm:px-6 flex gap-2">
                                    <?php if(auth()->user()->can('products.edit')): ?>
                                        <a href="<?php echo e(route('admin.products.edit', [$product->id, 'page' => request()->get('page')])); ?>" class="btn-default">
                ...
                <div class="my-4 px-4 sm:px-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        <?php echo e(__('Total Stock')); ?>: <span class="font-semibold"><?php echo e($totalStock); ?></span>
                    </p>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\varsity\resources\views/backend/pages/products/index.blade.php ENDPATH**/ ?>