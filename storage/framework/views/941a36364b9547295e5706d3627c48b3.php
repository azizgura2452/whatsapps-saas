...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('WhatsApp Chatbox')); ?> | <?php echo e(config('app.name')); ?>
        ...
        <div
            ...
            <aside class="w-[200px] shrink-0 border-r border-gray-200 dark:border-gray-800 flex flex-col"
                ...
                <div class="px-3 py-2 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                    <div class="relative">
                        <input type="text" name="q" value="<?php echo e($q); ?>" form="wa-search-form" placeholder="<?php echo e(__('Search')); ?>"
                    ...
                    <form id="wa-search-form" method="GET" action="<?php echo e(route('admin.whatsapp.chatbox')); ?>"></form>
                </div>



                
                <div class="flex-1 overflow-y-auto" id="chatbox-sidebar" data-page="<?php echo e($customers->currentPage()); ?>"
                    data-has-more="<?php echo e($customers->hasMorePages() ? '1' : '0'); ?>">
                    <?php echo $__env->make('backend.pages.chatbox._customers', ['customers' => $customers, 'selectedId' => $selectedId], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div id="chatbox-pane" class="flex-1 overflow-hidden">
                    <?php if($selectedId): ?>
                        <div id="chatbox-loading"
                            ...
                            <?php echo e(__('Loading chat…')); ?>

                        </div>
                    <?php else: ?>
                        <div class="h-full grid place-items-center text-gray-500 dark:text-gray-400 p-6 text-center">
                            <div>
                                <div class="text-xl font-semibold mb-2"><?php echo e(__('Select a conversation')); ?></div>
                                <div><?php echo e(__('Choose a customer from the left to view messages')); ?></div>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        (function () {
            ...
            let activeCustomerId = <?php echo json_encode($selectedId ?: null, 15, 512) ?>;
            let lastTimestamp = 0;
            let pollTimer = null;

            const routes = {
                chat: (id) => `<?php echo e(route('admin.whatsapp.chatbox.chat', ':id')); ?>`.replace(':id', id),
                poll: (id) => `<?php echo e(route('admin.customers.messages', ':id')); ?>`.replace(':id', id), // reuse existing
            };
    ...
    <script>
        (function () {
            ...
            const q = <?php echo json_encode($q ?? '', 15, 512) ?>;
            ...
            async function loadMore() {
                ...
                try {
                    const url = `<?php echo e(route('admin.whatsapp.chatbox')); ?>?page=${nextPage}&q=${encodeURIComponent(q)}`;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\varsity\resources\views/backend/pages/chatbox/index.blade.php ENDPATH**/ ?>